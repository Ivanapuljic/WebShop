...
<nav class= "navbar navbar-default navbar-fixed-top" id="navbar"  style="background-color: #000000;" >
  <div class="container" >
    <a href="/webshop/user/home.php" class="navbar-brand" id="text" style="font-size: 30px; color:white;"><b>C&S</b> </a>
...
?> 
    ...
    <ul class="navbar-right" style="margin-top: 10px; color:black;">
        <li> <a href="orders.php" id="cart" style="color:white; font-size: 25px; " >Orders</a> </li>
    </ul>
